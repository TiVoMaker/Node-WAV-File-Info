...
wfi.infoFromBuffer = function (buffer, maybeTotalSize) {
    var read_result = {}
    ...
    if (maybeTotalSize && ((read_result.chunk_size + 8) !== maybeTotalSize)) invalid_reasons.push("chunk_size does not match file size")
